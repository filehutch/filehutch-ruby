...
class DirectUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "routes are mounted under the engine" do
    assert_equal "/assethutch/uploads", asset_hutch.uploads_path
    assert_equal "/assethutch/uploads/#{ApiStubs::FILE_ID}/complete", asset_hutch.complete_upload_path(ApiStubs::FILE_ID)
  end
