...
require "generators/file_hutch/install/install_generator"
require "generators/file_hutch/attachment/attachment_generator"

class InstallGeneratorTest < Rails::Generators::TestCase
  tests FileHutch::Generators::InstallGenerator
  ...
  test "creates the initializer, mounts the engine, and pins the controller" do
    run_generator
    assert_file "config/initializers/file_hutch.rb", /FileHutch.configure/
    assert_file "config/routes.rb", /mount FileHutch::Engine => "\/file_hutch"/
    assert_file "config/importmap.rb", /pin "file_hutch\/direct_upload_controller"/
  end
end

class AttachmentGeneratorTest < Rails::Generators::TestCase
  tests FileHutch::Generators::AttachmentGenerator
  destination File.expand_path("../tmp/generators", __dir__)
